---
description: Use for Firebase Cloud Functions work under functions/ — callable exports in functions/index.js, admin/user/listing/company workflows, or shared helpers in functions/lib/. Covers auth/authorization checks, input validation, REGION config, response shape, transactions, and audit-event writes for sensitive admin actions.
---

# Backend Functions Skill
